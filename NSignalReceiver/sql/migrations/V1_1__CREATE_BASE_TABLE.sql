CREATE TABLE public.option_trade_161
(
...
CREATE TABLE "public"."option_open_interest_161" (
  "id" bigserial PRIMARY KEY,
...
CREATE TABLE public.option_trade_162
(
    id bigserial PRIMARY KEY,
    stock_symbol character(6) COLLATE pg_catalog."default" DEFAULT NULL::bpchar,
    expiration integer,
...
CREATE TABLE "public"."option_open_interest_162" (
  "id" bigserial PRIMARY KEY,
  "stock_symbol" char(6) COLLATE "pg_catalog"."default" DEFAULT NULL::bpchar,
  "expiration" int2 DEFAULT NULL,
  "call_put" char(1) COLLATE "pg_catalog"."default" DEFAULT NULL::bpchar,
...
CREATE TABLE public.option_trade_164
(
    id bigserial PRIMARY KEY,
    stock_symbol character(6) COLLATE pg_catalog."default" DEFAULT NULL::bpchar,
    expiration integer,
...
CREATE TABLE "public"."option_open_interest_164" (
  "id" bigserial PRIMARY KEY,
  "stock_symbol" char(6) COLLATE "pg_catalog"."default" DEFAULT NULL::bpchar,
  "expiration" int2 DEFAULT NULL,
  "call_put" char(1) COLLATE "pg_catalog"."default" DEFAULT NULL::bpchar,
